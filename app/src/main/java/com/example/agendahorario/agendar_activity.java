...
public class agendar_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSelecionarHorario.setEnabled(false); // Desabilitado até selecionar data
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, year, month, dayOfMonth) -> {
            ...
            // Limpa seleções anteriores e busca horários
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (Agendamento agendamento : response.body()) {
                        try {
                            ...
                            // Ignora horários mal formatados
                        }
                    }
                }
                // Habilita o botão de horário após a busca (mesmo que falhe)
