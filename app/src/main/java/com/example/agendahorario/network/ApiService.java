...
public interface ApiService {
    ...
    // Busca todas as reservas para uma quadra específica em uma data
    @GET("reservations")
    Call<List<Agendamento>> getReservationsForCourt(@Query("court_id") int courtId, @Query("date") String date);
